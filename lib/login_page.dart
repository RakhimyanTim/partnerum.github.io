...
class _LoginPageState extends State<LoginPage> {
  ...
  String _phoneNumber = 'assets/images/phone_number.svg';
                ...
                child: Column(
                  ...
                  children: <Widget>[
                    ...
                    new FlatButton(
                      ...
                      onPressed: () {
                        _lunchPrivacyUrl(lunchUrl: 'https://partnerum.com/privacy/',);
                      },
                    ),
                    isOtpSent
                        ? _getOtpBox()
  ...
  _verifyOtp() async {
    ...
    if (!_isLoading && _phoneForm.currentState.validate()) {
      ...
      final FirebaseUser user = await _fbAuth.signInWithCredential(credential);
  ...
  void _lunchPrivacyUrl({lunchUrl}) async {
    if (await canLaunch(lunchUrl)) {
      await launch(lunchUrl);
    } else {
      throw 'Сайт - $lunchUrl - не найден';
    }
  }
  ...
  Widget _buildOptInputField() {
    return new Container(
      ...
      child: new TextFormField(
        ...
        decoration: new InputDecoration(
          labelText: 'Код',
          hintText: 'Введите 6-ти значный код подтверждения',
//            prefixIcon: new Icon(
//              Icons.message,
//              color: Colors.black,
//            ),
